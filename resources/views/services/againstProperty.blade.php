...
<section class="againstPropertyLoan section">
    <h1 class="againstPropertyLoan_title d-flex justify-content-center mb-4">Against Property Loan</h1>
    <div class="container">
        <div class="image"></div>
    </div>
</section>
...
<div class="againstPropertyLoan-content">
    <div class="container">
        <p class="h2 my-4">Loan Against Property (LAP) Service</p>
        <p class="text">Unlock the potential of your property with our Loan Against Property (LAP) Service. Whether you
            need funds for expanding your business, meeting personal expenses, or fulfilling other financial goals, our
            LAP Service is designed to provide you with hassle-free access to capital.
            <br>
            <br>
            Our experienced team will assist
            you in leveraging the value of your property as collateral, helping you secure loans at competitive interest
            rates with flexible repayment options. We ensure a seamless and efficient process, from property evaluation
            to loan disbursal, allowing you to access the funds you need quickly.
            <br>
            <br>Trust our LAP Service to help you
            unlock the hidden value of your property and meet your financial objectives with ease and confidence.
        </p>
...
<div class="againstPropertyLoan-progress mb-5">
    <div class="container">
        <div class="row">
...
<div class="enquiry-form py-5">
    <div class="container">
        <h2 class="title text-dark text-center">Looking for "Loan Against Property (LAP) Service" ?</h2>
